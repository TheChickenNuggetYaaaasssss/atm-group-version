...
class View {
    ...
    public void goodbye(Stage window) {
        ...
        goodbyeScene.getStylesheets().add(
                getClass().getResource("/atm.css").toExternalForm()
        );
    ...
    public void start(Stage window) {
        ...
        buttonPane.setPrefTileWidth(100);
        buttonPane.setHgap(5);
        buttonPane.setVgap(5);

        buttonPane.setAlignment(Pos.CENTER);

// prevents resizing/reflow
        buttonPane.setMinWidth(Region.USE_PREF_SIZE);
        buttonPane.setMaxWidth(Region.USE_PREF_SIZE);
        buttonPane.setAlignment(Pos.CENTER);
